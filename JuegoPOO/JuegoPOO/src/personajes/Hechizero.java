...
public class Hechizero extends Personaje {
    ...
    public Hechizero (String nombre) {
        super(nombre, 100, 50); // Vida: 100, Ataque: 20
        this.rutaImagen = "Imagenes/hechizero.png"; //Asigna la ruta de la imagen del hechizero
    }
    ...
    public void atacar(Personaje enemigo) {
        System.out.println(nombre + " Tira ola de fuego.");
